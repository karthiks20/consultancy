  ...
  return (
    <Box width="100%" boxShadow="rgba(33, 35, 38, 0.1) 0px 10px 10px -10px" position="fixed" top={0} bgColor="white" zIndex={4}>
      ...
      <Link to="/"><Flex align="center" gap="10px">
        ...
        <Hide below="lg">
        <Text color="#bf9852" fontSize="20px" fontWeight={500}>GOLDLINE FURNITURES</Text>
        </Hide>
        </Flex>
      </Link>
      ...
      <Flex  justifyContent="space-between" pl="2%" pr="2%" fontSize="14px">
        ...
        {/* </Hide> */}
        <Link to="/about" ><Button variant="unstyled" fontSize="13px" fontWeight="400"  _hover={{color:"#bf9852", borderBottom:"1px solid #bf9852", borderRadius:"none" }}>About</Button></Link>
        <Link to="/contact" ><Button variant="unstyled" fontSize="13px" fontWeight="400"  _hover={{color:"#bf9852", borderBottom:"1px solid #bf9852", borderRadius:"none" }}>Contact</Button></Link>
        <Hide below="md">
